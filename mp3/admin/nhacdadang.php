...
window.onload = externalLinks;
                        ...
                        <table width="348" border="0">
                          <tr>
                            <td width="127"><input class="btn btn-large" type="submit" value="Sửa Lại" onClick="return confirm('Xác nhận sửa ?');" name="sua" ></td>
							<td width="12">&nbsp;</td>
                            <td width="187"><input class="btn btn-large" type="submit" value="Xóa Nhá" onClick="return confirm('Xác nhận xóa ?');" name="no" ></td>
                          </tr>
                        </table>
                        <p>&nbsp; </p>
                    </form>
