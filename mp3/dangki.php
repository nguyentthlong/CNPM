...
function check_form()
{
	...
	
	{
		...
		document.form.username.focus();	//Đặt lại tiêu điểm (Tức là con tro chuột ) vào ô bị lỗi
		...
		loiuser.innerHTML="Tên tài khoản phải lớn hơn 5 kí tự !";
	...
	if(pass.length<6) 
		{			
			...
			loimk.innerHTML="Mật khẩu phải nhiều hơn 5 kí tự !!	!"; //Xuất ra dòng thông báo lỗi nếu mk<5 .

			document.form.password.focus(); //Đặt lại tiêu điểm (Tức là con tro chuột ) vào ô bị lỗi
			return false; //Quay lại check tiếp khi nhận đc tiêu điểm .
...
.rq, .error{color: red}
			...
			<i>Dấu ( <span style="color:red">*</span>) là ô bắt buộc </i>
